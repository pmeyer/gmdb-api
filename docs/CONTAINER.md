...
- `SPRING_R2DBC_USERNAME`: Database username consumed directly by Spring Boot. The image and Compose default to
  `gmdb_app_user`.
- `GMDB_DATABASE_USERNAME`: Compose convenience variable mapped to `SPRING_R2DBC_USERNAME`.
